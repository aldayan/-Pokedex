...
class utilities{
  ...
  public  $estatus =[1=>"Seleccione",2=>"Tipo fuego",3=>"Tipo agua",4=>"Tipo tierra",3=>"Tipo aire"];

  public  $carrera =[1=>"Seleccione",2=>"Rojo los de kantos",3=>"amarillo de lo johto",4=>"Azul de lo Hoenn",5=>"Verde de los Sinnoh",
6=>"Naranja de los Kalos"];
